...
ESP-NOW. This sketch still uses the same symmetric ESP-NOW lifecycle as any
other peer: create controller, register receive handling, call connect(), and
use sendData() for outbound payloads. Incoming ESP-NOW payloads are copied in
the receive callback and printed later from loop(), keeping callback work short
and non-blocking.
*/
...
#define BRIDGE_OUTPUT_MODE_CSV_VERBOSE 1
#endif
#ifndef BRIDGE_OUTPUT_MODE_CSV_COMPACT
#define BRIDGE_OUTPUT_MODE_CSV_COMPACT 0
#endif
